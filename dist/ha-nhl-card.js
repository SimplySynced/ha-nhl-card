    ...
    if (stateObj.state == 'IN') {
        return html`
          ...
          <ha-card>
            ...
            <div class="play-clock">Q${stateObj.attributes.period} - ${stateObj.attributes.clock}</div>
            <div class="line"></div>
            <div class="sub2">
    ...
    if (stateObj.state == 'PRE') {
        return html`
          ...
          <ha-card>
              ...
              <div class="line"></div>
              <div class="sub1">
                <div class="date">Puck drops ${stateObj.attributes.puck_drop}</div>
        ...
        <ha-card>
          <div class="card">
            ...
            <div class="card-content">
              ...
              <div class="bye">No games within 24 hours</div>
            </div>
          </div>
        </ha-card>
      `;
